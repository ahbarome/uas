...
namespace UAS.Core.Mobile.UI.Adapters
{
    public class SpinnerAdapter : ArrayAdapter<SpaceDTO>
    {
        ...
        {
            return (long)this.mItems.IndexOf(this.mItems.ElementAt(position));
        }
        ...
        private View GetCustomView(int position, View convertView, ViewGroup parent)
        {
            ...
            txtSpinnerItem.Text = string.Concat(this.mItems.ElementAt(position).IdSpace.ToString(), this.mItems.ElementAt(position).SpaceName);
