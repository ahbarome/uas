...
TableTools.BUTTONS = {
	...
	"print": $.extend( {}, TableTools.buttonBase, {
		"sInfo": "<h6>Vista previa de la impresión</h6><p>Por favor seleccione la opción de impresión de su navegador"+
		  "para imprimir esta tabla. Presioine escape para finalizar.</p>",
		"sMessage": null,
		"bShowAll": true,
...
TableTools.DEFAULTS = {
	...
	"aButtons":        [ "copy", "csv", "xls", "pdf", "imprimir" ],
	"oTags": {
		"container": "div",
